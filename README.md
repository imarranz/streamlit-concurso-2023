...
Se puede definir el nombre del nuevo entorno
...
Cuando no necesitamos este entorno podemos eliminarlo
...
#### Recursos
  ...
  * _Python Data Science Handbook_ de Jake VanderPlas: Un libro que cubre temas avanzados de Python para el análisis de datos, como la visualización de datos, el aprendizaje automático y la manipulación de datos con pandas.
